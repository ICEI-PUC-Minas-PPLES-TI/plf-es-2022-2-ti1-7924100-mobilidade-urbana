...
> | --- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ------------------------ |
> | 1   | `Favoritar linha de ônibus e visualizá-la na página de perfil` <br><br>Passo a passo:<br>`1.` Fazer login.<br>`2.` Abrir página inicial (home).<br>`3.` Pesquisa linha de ônibus.<br>`4.` Clicar no botão "favoritar".<br>`5.` Abrir página de perfil.<br><br>`Resultado esperado:`<br>A linha favoritada pelo usuário deve ser mostrada no card de favoritos, em sua área de perfil. | RF-001 e RF-002          |
