...
> | 2   | `Inserir linha de ônibus e  visualizá-la no mapa` <br><br>Passo a passo:<br>`1.` Abrir página inicial (home).<br>`2.` Pesquisar linha de ônibus e clicar no botão de pesquisa.<br><br>`Resultado esperado:`<br>A linha informada pelo usuário deve ser mostrada no mapa.                                                                                                                | RF-003 e RF-004          |
